...
async function schedule(crawler_code)
{
    ...
    var crawlers = ['listCrawler', 'detailFastCrawler', 'CTFileCrawler', 'CTDownloader', 'doubanCrawler', 'doubanFastCrawler'];
...
process.on('exit', (code) => {
  ...
  {
      require('child_process').fork(Configs.workingPath+'scheduler.js',[crawler_code%Configs.crawlerStack] );
  }
